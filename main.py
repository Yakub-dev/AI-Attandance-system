...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'yakub0013k@gmail.com' ")
...
window.configure(background='#062f8a')
...
message3 = tk.Label(window, text="AI Attendance Tracker-Smart Attendance System Using ML" ,fg="white",bg="#062f8a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#c3c6e3",bg="#062f8a" ,width=30 ,height=0,font=('comic',18, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#c3c6e3",bg="#062f8a" ,width=30 ,height=0,font=('comic', 18, ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="white",bg="#65188c" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="white",bg="#65188c" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="white"  ,bg="#308578"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
